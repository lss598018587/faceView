...
public class MappedBiggerFileReader {
    ...
    public MappedBiggerFileReader(String fileName, int arraySize) throws IOException {
        ...
        System.out.println("被Int最大整型除余，剩余几个文件："+number);
    ...
    public static void main(String[] args) throws IOException {
        //65536  64KB
        MappedBiggerFileReader reader = new MappedBiggerFileReader("/Users/miaomiao/Desktop/miao.txt", 65536);
        long start = System.currentTimeMillis();
        while (reader.read() != -1) ;
        long end = System.currentTimeMillis();
        reader.close();
        System.out.println("MappedBiggerFileReader: " + (end - start)/1000);
    }
}
