...
public class WriteTest {
    ...
    public void simpleWrite() {
        // 写法1
        String fileName =   "/Users/wangmiao/Desktop/skus.xlsx";
...
//        String fileName =   "/Users/wangmiao/Desktop/skus.xls";
//
...
//    }
    ...
    private List<DemoData> data() {
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            data.setNameStr("字符串胜多负少的发生地方阿斯顿发斯蒂芬阿斯蒂芬圣诞快乐放进去来我家；凉快手动阀昆仑决；拉水电费金坷垃；几十度开了房阿斯蒂芬" + i);
            data.setSex("行吧手动阀是的发送到发送到发发爱上对方是否阿斯顿发生发顺丰手动阀阿所发生的啊是"+i);
            data.setAddress("住址法规和地方规划热后如何共和国黄冠亨和而会更好辅导费搞的跟我法国潍坊港为发改委个为各位哥果然改为个人"+i);
            data.setAdd1("住址法规和地方规划热后如何共和国黄冠亨和而会更好辅导费搞的跟我法国潍坊港为发改委个为各位哥果然改为个人"+i);
            data.setAdd2("住址法规和地方规划热后如何共和国黄冠亨和而会更好辅导费搞的跟我法国潍坊港为发改委个为各位哥果然改为个人"+i);
            data.setAdd3("住址法规和地方规划热后如何共和国黄冠亨和而会更好辅导费搞的跟我法国潍坊港为发改委个为各位哥果然改为个人"+i);
            data.setAdd4("住址法规和地方规划热后如何共和国黄冠亨和而会更好辅导费搞的跟我法国潍坊港为发改委个为各位哥果然改为个人"+i);
            data.setCreateTime(new Date());
            data.setNumberCar(0.56);
            list.add(data);
        }
        return list;
    }
